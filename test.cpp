...
int main()
{
	...
	// FILE *outfile = fopen("/home/dong/Downloads/line_detector-master/test.png","wb");
    ...
    // }
	// fread(pBuf, sizeof(unsigned char), (height * width),infile);
	...
	//左上角是坐标原点
	//用法和cv::rect一样
	boundingbox_t Bbox = { 0,120,512,264 };
	float scalex =1.0;
	float scaley =1.0;
	int Flag = 0;
    ...
    Flag = EdgeDrawingLineDetector(input,512,384,scalex,scaley,Bbox,Lines);
